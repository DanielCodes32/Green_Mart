        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Center(
            child: SvgPicture.asset(  AppAssets.carrotsveg,)
              ...
              SizedBox(height: 75,),
           Text('Login',style: TextStyles.title.copyWith(color: AppColors.blackColor),),
          ...
          Align(
            ...
            child: Text('Forgot Password?',style: TextStyles.body.copyWith(color:AppColors.blackColor, fontWeight: FontWeight.w600),),
          ),
          SizedBox(height: 15,),
          ...
          Row(
            ...
            children: [
              Text("Don't have an account?",style: TextStyles.body.copyWith(color:AppColors.blackColor, fontWeight: FontWeight.w600),),
              SizedBox(width: 5,),
              TextButton(onPressed: (){
                pushReplacement(context, SignupScreen());
              },style: TextButton.styleFrom(padding: EdgeInsets.zero), child: Text('Sign Up',style: TextStyles.body.copyWith(color: AppColors.primaryColor,fontWeight: FontWeight.w600),))
            ],
          )
          ],
        ),
